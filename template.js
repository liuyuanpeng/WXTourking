...
// model文件模版
const modelTep = `import { Reducer } from 'react-redux';
...
const connectTmp1 = `import { AnyAction, Dispatch } from 'react-redux';
...
if (!connectFile.includes(`import { StateType as ${dirName}State } from './${dirName}Model'`)) {
  const _newConnectFile = connectFile.replace(/import { AnyAction, Dispatch } from 'react-redux';/, connectTmp1);
